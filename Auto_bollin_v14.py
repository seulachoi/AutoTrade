        ...
        if (now.hour == 8 and 50 <= now.minute <= 59) or (now.hour == 9 and 00 <= now.minute <= 15):
            if krw_balance is not None and krw_balance > 0:
                ...
                for ticker in tickerlist:
                    ...
                    if change > 5 and close_1 > open_1 and head < body*2 and (((now_price/band_high_1)-1)*100) > 1 and (((now_price/band_high_1)-1)*100) < 3 and (((now_price/band_high_3)-1)*100) > 0.5 and band_width_1 > band_width_1_1*2 and band_width_3 > band_width_3_1*2 and ((close_3 / bb_center_3 > 1.01) or (close_3_3 / bb_center_3_3 > 1.01) or (close_3_2 / bb_center_3_2 > 1.01) or (close_3_1 / bb_center_3_1 > 1.01)):
            ...
            if krw_balance is not None and krw_balance > 0:
                ...
                for ticker in tickerlist_B:
                    ...
                    if price is not None and len(trend_false_list) == 0 and open < band_high and ((price/band_high)-1)*100 > 0.5 and body > 0 and volume_3m > 10000 and close_3m_2 > open_3m_2 and close_3m_3 > open and close_3m > open_3m and price > close_3m_2 and price > close_3m_4 and price > close_3m_6 and price > close_3m_8: ###수정
