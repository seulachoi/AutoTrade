...
# 볼린저밴드 중앙값 1% 돌파 중 과거 10개 봉이 볼밴 하단값 돌파한 적 있는지 확인
    ...
    while True:
        ...
        if krw_balance is not None and krw_balance > 0:
            ...
            for ticker in tickerlist:
                ...
                if price is not None and price > (open + body_b2*0.5) and open <= bb_center and ((price/bb_center)-1)*100 > 1 and body > 0 and price > open_3m:
            ...
            for Bticker in Bollin_tikcer_list:
                ...
                for i in range(1,11):
                    ...
                    if (df_1_low / band_low_df_close) < 0.98:
            ...
            if len(bollin_data) == 0:
                ...
                result = f"{now}, 티커: {Bollin_coin_name}, 하단돌파: {Bollin_coin_number}, 현재가: {Bollin_coin_price}, 거래량: {volume}"
                print(f"{now}, 티커: {Bollin_coin_name}, 하단돌파: {Bollin_coin_number}, 현재가: {Bollin_coin_price}, 거래량: {volume}")
                
                #buy_amount = krw_balance*0.5
                ...
                while True:
                    ...
                    if upbit.get_balance(Bollin_coin_name) > 0:
                        ...
                        if forsell_price is not None and forsell_price >= band_high*0.995:
                            sell_price = band_high*0.998
                        print(sell_price)
