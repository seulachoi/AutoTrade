        ...
        if (now.hour == 8 and 50 <= now.minute <= 59) or (now.hour == 9 and 00 <= now.minute <= 15):
            if krw_balance is not None and krw_balance > 0:
                ...
                for ticker in tickerlist:
                    ...
                    if now_price < 10000 and (((now_price/band_high_1)-1)*100) > 1 and (((now_price/band_high_1)-1)*100) < 3 and (((now_price/band_high_3)-1)*100) > 0.5 and band_width_3 > band_width_3_2*2 and ((open_3_5 < bb_center_3_5 and close_3_5 > bb_center_3_5 and close_3_5 / bb_center_3_5 > 1.01) or (open_3_4 < bb_center_3_4 and close_3_4 > bb_center_3_4 and close_3_4 / bb_center_3_4 > 1.01) or (open_3_3 < bb_center_3_3 and close_3_3 > bb_center_3_3 and close_3_3 / bb_center_3_3 > 1.01) or (open_3_2 < bb_center_3_2 and close_3_2 > bb_center_3_2 and close_3_2 / bb_center_3_2 > 1.01) or (open_3_1 < bb_center_3_1 and close_3_1 > bb_center_3_1 and close_3_1 / bb_center_3_1 > 1.01)):
            ...
            if krw_balance is not None and krw_balance > 0:
                ...
                for Bticker in Bollin_tikcer_list_A:
                    ...
                    for i in range(1,11):
                        ...
                        if (df_1_low / band_low_df_close) < 0.98: ###수정 0.98
                ...
                for ticker in tickerlist_B:
                    ...
                    for i in range(2,51):
                        if df_raw.iloc[-i]["close"] < price and df_raw.iloc[-i]["close"] > price*0.95:
                            trend = True
                        else:
                            trend = False

                    #현재가가 볼밴 상단을 1% 돌파하고 있으면서, 과거 1-50번째 종가가 현재가보다 낮아야함 (즉 하락 추세가 아닌), 3분봉 1,2,3,5,7,9번째 종가보다 현재가가 높아야함 (급락하는 경우 거르기위해)
                    if price is not None and trend is True and open < band_high and ((price/band_high)-1)*100 > 0.5 and body > 0 and volume_3m > 10000 and close_3m > open_3m and price > close_3m_2 and price > close_3m_4 and price > close_3m_6 and price > close_3m_8: ###수정
                        #and open < band_high and ((price/band_high)-1)*100 > 0.5 and body > 0 and volume_3m > 10000 and close_3m > open_3m and price > close_3m_2 and price > close_3m_4 and price > close_3m_6 and price > close_3m_8
                        print("tickerlist_B", ticker, trend)
                ...
                for Bticker in Bollin_tikcer_list_B:
                    ...
                    for i in range(1,11):
                        ...
                        if df_1_close > bb_center_df_close and df_1_close/bb_center_df_close > 1.01: ####수정
                            ...
                            # df_1_open / bb_center_df_close < 0.995 and and df_1_close > bb_center_df_close and df_1_close/bb_center_df_close > 1.01
                            number = i
                            ...
                            for i in range(i,21):
                                ...
                                #볼밴 하단 값 돌파한 적 있는지 
                                if df_21_low/band_low_df_close < 0.99 : ###수정 0.99
                                    Bollin_tikcer_list_buy.append(Bticker)
                ...
                if len(bollin_data) == 0:
                    ...
                    #텔레그램으로 보내요
                    result = f"{now}, 티커: {Bollin_coin_name}, 거래량:{maxs}, 현재가: {Bollin_coin_price}"
                    print(f"{now}, 티커: {Bollin_coin_name}, 거래량:{maxs}, 현재가: {Bollin_coin_price}")
                    
                    chat_token = "1827470195:AAGzfwuZtBxbind09ivsdDtcrHfb8tjkAic"
                    bot = telegram.Bot(token = chat_token)
                    chat_id = 1653560820
                    bot.sendMessage(chat_id=chat_id, text=result)
                    bot.sendMessage(chat_id=chat_id, text=bollin_data)
