        ...
        while True:
            ...
            if krw_balance > 0:
                ...
                for ticker in tickerlist:
                    ...
                    if last_volume > 100000 and last_value > average_value_10*value_k and price >= target and now_15m_price > last_15m_price and now_15m_price > last_30m_price and price is not None:
                        ...
                        test_message = [ticker, last_volume, price, Last_close_Value]
